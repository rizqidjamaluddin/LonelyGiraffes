                                       ...
                                       <tbody>
                                          <tr>
                                             <td width="30" height="30" align="right">
                                                <div class="imgpop">
                                                   <a target="_blank" href="https://www.facebook.com/lonelygiraffes">
                                             ...
                                             <td width="30" height="30" align="center">
                                                <div class="imgpop">
                                                   <a target="_blank" href="https://twitter.com/lonelygiraffes">
                        ...
                        <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              ...
                              <tr>
                                 <td>
                                    <!-- logo -->
                                       <div style="font-family: Helvetica, arial, sans-serif; font-size: 36px; color: #333333; text-align:center; line-height: 30px; margin-bottom: 20px;" st-title="fulltext-heading">
                                                Lonely Giraffes
                                       </div>
                                    <!-- end of logo -->
                                 </td>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td align="center" st-image="banner-image">
                                    <div class="imgpop">
                                       <a target="_blank" href="#"><img width="400" border="0" height="300" alt="" border="0" style="display:block; border:none; outline:none; text-decoration:none;" src="img/giraffe.jpg" class="banner"></a>
                                    </div>
                                 </td>
                              </tr>
                           </tbody>
                                       ...
                                       <tbody>
                                          ...
                                          <tr>
                                             <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                Well we aren't exactly elephants so we tend to forget. Click reset below to reset your password. Giraffe on!
         ...
         <td>
            <table width="600" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
               <tbody>
                  <tr>
                     <td width="100%">
                        <table width="600" cellpadding="10px" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              <tr>
                                 <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 14px;color: #666666" st-content="postfooter">
                                    Please ignore this email if you didn't request it
                                 </td>
                              </tr>
                              <tr>
                                 <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 14px;color: #666666" st-content="postfooter">
                              ...
                              <tr>
                                 <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 14px;color: #666666" st-content="postfooter">
                                    We take privacy very seriously. If you're interested, here is a link to our <a href="#" style="text-decoration: none; color: #0a8cce">privacy policy</a> 
                                 </td>
                              </tr>
                              <!-- Spacing -->
                              <tr>
